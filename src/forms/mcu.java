...
public class mcu extends JFrame implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent ae) 
    {
     if(ae.getSource()==b1)
     {
      ...
      cs.gmcse=Float.parseFloat(t1.getText());
      cs.gmit=Float.parseFloat(t2.getText());
      cs.gmece=Float.parseFloat(t3.getText());
      cs.gmeee=Float.parseFloat(t4.getText());
      cs.gmma=Float.parseFloat(t5.getText());
      cs.omcse=Float.parseFloat(t6.getText());
      cs.omit=Float.parseFloat(t7.getText());
      cs.omece=Float.parseFloat(t8.getText());
      cs.omeee=Float.parseFloat(t9.getText());
      cs.omma=Float.parseFloat(t10.getText());
      cs.smcse=Float.parseFloat(t11.getText());
      cs.smit=Float.parseFloat(t12.getText());
      cs.smece=Float.parseFloat(t13.getText());
      cs.smeee=Float.parseFloat(t14.getText());
      cs.smma=Float.parseFloat(t15.getText());
    ...
    {
      mcu m=new mcu("MTech Cutoff Update");  
        m.setSize(1000,650);
        m.setLocation(50,50);
